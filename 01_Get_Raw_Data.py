...
handler = RotatingFileHandler('log/01.log', maxBytes=1000000, backupCount=1)
        ...
        async for message_json in websocket:
            ...
            if message_type == "PositionReport":
                ...
                if len(pos_data)>chunksize_pos:
                    ...
                    pq.write_to_dataset(table,root_path='position_reports', schema=schema,partition_cols=['year','month','day','hour'])
                    pos_data = []
            ...
            if message_type == "ShipStaticData":
                ...
                if len(static_data)>chunksize_static:
                    ...
                    pq.write_to_dataset(table,root_path='static_ship_data', schema=schema_static,partition_cols=['year','month','day','hour'])
                    static_data = []
