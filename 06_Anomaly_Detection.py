...
handler = RotatingFileHandler('log/06_Anomaly_Detection.log', maxBytes=1000000, backupCount=1)
...
def anomaly_detection():
    ...
    os.system(f"rm -rf anomaly_detection_data/*")
    df=pd.read_parquet("grouped_data")
    ...
    pq.write_to_dataset(table,root_path='anomaly_detection_data')
